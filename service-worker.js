const CACHE_NAME='night-wardens-digital-field-office-v7';
const APP_SHELL=['./','./index.html','./app.js','./night_wardens_data.json','./manifest.webmanifest','./firebase-config.js','./auto-gm.html','./auto_gm_data.json'];
