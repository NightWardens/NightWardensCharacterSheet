const CACHE_NAME='night-wardens-digital-field-office-v6';
const APP_SHELL=['./','./index.html','./app.js','./night_wardens_data.json','./manifest.webmanifest','./firebase-config.js'];
